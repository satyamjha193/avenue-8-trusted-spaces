...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Dcz_HnCF.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DfyRs1nj.js").then((n2) => n2.r),
    import("./start-CXLKMccK.js"),
...
var ROUTER_BASEPATH = "avenue-8-trusted-spaces";
var SERVER_FN_BASE = "/avenue-8-trusted-spaces/_serverFn/";
